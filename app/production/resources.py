...
class OperationGetResource(BaseGetResource):
    ...
    schema_list = staticmethod( lambda: OperationService.get_obj_list(request.args.to_dict()))
    output_fields = op_fields
...
class ProductionResourceGetResource(BaseGetResource):
    ...
    schema_list = staticmethod( lambda: ProductionResourceService.get_obj_list(request.args.to_dict()))
    output_fields = production_resources_fields
...
class VariantUseResourceGetResource(BaseGetResource):
    ...
    schema_list = staticmethod( lambda: VariantResourceUsageService.get_obj_list(request.args.to_dict()))
    output_fields = variant_resource_usage
