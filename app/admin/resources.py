...
class WorkerGetResource(BaseGetResource):
    schema_get = staticmethod(
        WorkerService.get_obj
    )  # servicio para obtener un elemento
    schema_list = staticmethod(
        lambda: WorkerService.get_obj_list(request.args.to_dict())
    )  # servicio para obtener una lista de elementos
...
class JobGetResource(BaseGetResource):
    ...
    schema_list = staticmethod(
        lambda: JobService.get_obj_list(request.args.to_dict())
    )  # servicio para obtener una lista de elementos
