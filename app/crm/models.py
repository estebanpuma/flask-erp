...
class Client(BaseModel):
    ...
    client_category_id = db.Column(
        db.Integer,
        db.ForeignKey("client_categories.id", ondelete="RESTRICT"),
        nullable=True,
    )
    ...
    orders = db.relationship(
        "SaleOrder", back_populates="client", cascade="all, delete-orphan"
    )
...
class Provinces(db.Model):
    ...
    cantons = db.relationship(
        "Cantons", back_populates="province", cascade="all, delete-orphan"
    )
