...
from .resources import PaymentPlanCreateResource, PaymentPlanGetResource, PaymentPlanDeleteResource, PaymentPlanPatchResource
from .resources import InstallmentGetResource, PaymentTransactionPostResource, PaymentTransactionGetResource
...
payments_api.add_resource(PaymentPlanPatchResource, '/payment_plans/<int:resource_id>')
payments_api.add_resource(PaymentPlanDeleteResource, '/payment_plans/<int:resource_id>')


# Installments
payments_api.add_resource(InstallmentGetResource, '/installments/<int:id>')

#PaymentTransactions
payments_api.add_resource(PaymentTransactionPostResource, '/payment-transactions')
