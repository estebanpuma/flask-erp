...
payments_api.add_resource(
    PaymentMethodGetResource, "/payment-methods", "/payment-methods/<int:resource_id>"
)
payments_api.add_resource(PaymentMethodCreateResource, "/payment-methods")
payments_api.add_resource(
    PaymentMethodUpdateResource, "/payment-methods/<int:resource_id>"
)
payments_api.add_resource(
    PaymentMethodDeleteResource, "/payment-methods/<int:resource_id>"
)
...
payments_api.add_resource(
    ...
    "/payment-transactions/<int:resource_id>",
)
payments_api.add_resource(
    SalesPaymentTransactionGetResource,
    "/payment-transactions/<int:resource_id>/sale-order",
)
payments_api.add_resource(PaymentTransactionCreateResource, "/payment-transactions")
payments_api.add_resource(
    PaymentTransactionUpdateResource, "/payment-transactions/<int:resource_id>"
)
payments_api.add_resource(
    PaymentTransactionDeleteResource, "/payment-transactions/<int:resource_id>"
)
...
payments_api.add_resource(
    PaymentAgreementGetResource,
    "/payment-agreements",
    "/payment-agreements/<int:resource_id>",
)
payments_api.add_resource(
    SalesPaymentAgreementGetResource, "/payment-agreements/<int:resource_id>/sale-order"
)
payments_api.add_resource(PaymentAgreementCreateResource, "/payment-agreements")
payments_api.add_resource(
    PaymentAgreementUpdateResource, "/payment-agreements/<int:resource_id>"
)
payments_api.add_resource(
    PaymentAgreementDeleteResource, "/payment-agreements/<int:resource_id>"
)
