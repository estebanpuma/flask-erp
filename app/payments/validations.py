...
def validate_payment_plan_data(data):
    ...
    if 'total_installments' in data:
        if not isinstance(data['total_installments'], int) or data['total_installments'] < 1:
            raise ValidationError("El número de cuotas debe ser un entero mayor o igual a 1.")
